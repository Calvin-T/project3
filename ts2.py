...
#py ts1.py ts2ListenPort_a ts2ListenPort_c
def client_connection():
    ...
    while True:
        ...
        if query=="done":
            ...
            if query.lower() in TS2_DNS_Table:
                send_msg = TS2_DNS_Table[query.lower()]
                print("[S]: " + send_msg)
